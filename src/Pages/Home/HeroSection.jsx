...
export default function HeroSection() {
  ...
  // Reset typewriter animation on each update of 'profession'
  useEffect(() => {
    const element = document.getElementById("hero--section-title--color");
        ...
        <div className="hero--section--content">
          ...
          <h1 className="hero--section--title">
            ...
            <span
              ...
              className="hero--section-title--color typewriter"
            >
              {profession}
            </span>
